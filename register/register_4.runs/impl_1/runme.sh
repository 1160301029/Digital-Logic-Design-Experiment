...
HD_PWD='D:/vivado/register_4/register_4.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log register_4.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source register_4.tcl -notrace
