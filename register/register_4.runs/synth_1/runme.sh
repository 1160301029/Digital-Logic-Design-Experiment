...
HD_PWD='D:/vivado/register_4/register_4.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log register_4.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source register_4.tcl
