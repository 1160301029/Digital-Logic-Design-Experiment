...
HD_PWD='D:/vivado/Select/Select.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log select_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source select_1.tcl
