...
HD_PWD='D:/vivado/All_adder/All_adder.runs/all_adder_half_adder_1_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log all_adder_half_adder_1_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source all_adder_half_adder_1_0.tcl
