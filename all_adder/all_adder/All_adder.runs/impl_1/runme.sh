...
HD_PWD='D:/vivado/All_adder/All_adder.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log all_adder.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source all_adder.tcl -notrace
