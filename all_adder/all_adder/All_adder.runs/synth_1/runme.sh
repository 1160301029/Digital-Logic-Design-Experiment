...
HD_PWD='D:/vivado/All_adder/All_adder.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log all_adder.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source all_adder.tcl
