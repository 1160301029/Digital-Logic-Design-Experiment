...
#
# Generated by export_simulation on Wed May 31 23:12:26 +0800 2017
#
################################################################################
...
switch to the './all_adder.sh' script.

./all_adder.sh -reset_run
...
./all_adder.sh -noclean_files

For more information on the script, please type './all_adder.sh -help'.
