...
HD_PWD='D:/vivado/pingpang/pingpang.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log pingpang.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source pingpang.tcl
