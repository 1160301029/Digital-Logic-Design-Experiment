...
HD_PWD='D:/vivado/pingpang/pingpang.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log pingpang.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source pingpang.tcl -notrace
