...
HD_PWD='D:/vivado/mimasuo/mimasuo.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log mimasuo.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source mimasuo.tcl
