...
HD_PWD='D:/vivado/mimasuo/mimasuo.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log mimasuo.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source mimasuo.tcl -notrace
